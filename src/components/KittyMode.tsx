...
function CuteKitty({ walkPhase, isResting }: { walkPhase: number; isResting: boolean }) {
  ...
  return (
    ...
    >
      ...
      <ellipse cx="38" cy={32 + legOffset2} rx="4" ry="5" fill="#EA580C" />
      <ellipse cx="42" cy={32 + legOffset1} rx="4" ry="5" fill="#F97316" />
      ...
      <ellipse cx="14" cy={32 + legOffset1} rx="4" ry="5" fill="#EA580C" />
      <ellipse cx="18" cy={32 + legOffset2} rx="4" ry="5" fill="#F97316" />
